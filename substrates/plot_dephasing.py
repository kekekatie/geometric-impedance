...
ax.text(0.5, -0.15,
        ...
        "address as well as the fully coherent wave.\nThe classical walker has no standing "
        "states at all, and reads nothing. → the address lives in the wave's geometry-shaped "
        "STANDING states,\nnot in phase accrued over time. (Coherence is needed to HAVE "
        "eigenstates; interfering them is not what does the reading.)",
