...
| **Q1 — durable mark** (extended, **ERASE** at H, BUD-only future) | lineages **still differ at the final step** with **no archive present** — the past is transcribed into the active slice via CONTACT edges and **survives deletion** |
...
So **both** are true: the past leaves a **durable mark** on the active present (Fable's
